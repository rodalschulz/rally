...
9. **Admin de app** (`User.isAdmin`) ≠ owner de grupo. Privilegios: editar/borrar fechas, cambiar RSVP de miembros en fechas **aún abiertas**, saldar deudas pasadas, y el link de Google Calendar del grupo. Fechas Pasadas: asistencia inmutable (también para admin). No implica gestionar ajustes del grupo (nombre, invite, borrar).
